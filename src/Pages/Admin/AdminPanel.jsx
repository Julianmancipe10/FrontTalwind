        ...
        return (
          <div className="space-y-4 sm:space-y-6">
            ...
            {hasPermission(PERMISOS.CREAR_USUARIO) && (
              <button className="px-4 py-2 bg-[#39B54A] hover:bg-[#2d8f37] text-white rounded-lg transition-colors duration-200 font-medium shadow-sm text-sm sm:text-base">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-[#252b3b] rounded-lg p-4 sm:p-6">
              ...
              <Link 
                ...
                className="inline-block px-4 sm:px-6 py-2 sm:py-3 bg-[#39B54A] hover:bg-[#2d8f37] text-white rounded-lg transition-colors duration-200 font-medium shadow-sm text-sm sm:text-base"
              >
      ...
      <div className="container mx-auto px-4 py-4 sm:py-6 md:px-6 lg:px-8">
        ...
        <div className="flex items-start gap-4 mb-6 sm:mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-300 text-sm sm:text-base">Gestiona usuarios, permisos, roles y validaciones del sistema</p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6">
          ...
          <div className="w-full lg:w-64 xl:w-72">
            ...
            <div className="lg:hidden mb-4">
              <div className="flex space-x-2 overflow-x-auto pb-2">
                <button 
                  className={`flex-shrink-0 px-4 py-2 text-center rounded-lg font-medium transition-colors duration-200 text-sm
                    ${activeTab === 'users' 
          ...
          {/* Content */}
          <div className="flex-1 bg-[#1e2536] rounded-xl shadow-sm p-4 sm:p-6 border border-gray-700">
            {renderContent()}
          </div>
        </div>
      </div>
