    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white shadow-xl rounded-lg p-6 sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Crear Nueva Noticia</h2>
            ...
            <div>
              ...
              {stagedImages.length > 0 && (
                <div className="mt-4 space-y-4">
                  <h4 className="text-sm font-medium text-gray-700">Imágenes para agregar:</h4>
              ...
              {formData.imagenes.length > 0 && stagedImages.length === 0 && (
                <div className="mt-4 space-y-4">
                  <h4 className="text-sm font-medium text-gray-700">Imágenes cargadas:</h4>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
